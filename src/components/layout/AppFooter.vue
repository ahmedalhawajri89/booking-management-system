...
<template>
  <footer class="surface-soft border-primary-100 relative overflow-hidden border-t">
    <!-- top hairline in the brand gradient -->
    <div class="bg-sunset absolute inset-x-0 top-0 h-1" />

    <div class="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div class="border-primary-100 mb-12 grid gap-12 border-b pb-12 md:grid-cols-4">
        <div class="col-span-1 md:col-span-2">
          <div class="mb-6 flex items-center gap-2">
            <div class="bg-sunset shadow-primary-500/25 rounded-xl p-2 shadow-lg">
