...
export const heroChannels = [
  { key: 'online', label: 'الموقع', icon: MousePointerClick as LucideIcon },
  { key: 'phone', label: 'الهاتف', icon: CalendarCheck as LucideIcon },
  { key: 'walk_in', label: 'الاستقبال', icon: BadgeCheck as LucideIcon },
]
