...
export const useSettingsStore = defineStore('settings', () => {
   ...
   */
  const iconKeys = ref<Record<string, string>>({})
  const iconKeyOf = (serviceId: string) => iconKeys.value[serviceId] ?? 'Sparkles'
  ...
  function saveService(row: ServiceRow): void {
  ...
  function saveResource(resource: Resource): void {
  ...
  function saveHours(next: BusinessHours[]): void {
